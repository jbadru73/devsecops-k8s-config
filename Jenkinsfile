     ...
     stages {
      ...
      stage('Vulnerability Scan - Docker ') {
        steps {
            ...
            "OPA Conftest": {
              sh 'docker run --rm -v /var/lib/jenkins/workspace/devsecops-numeric application:/project openpolicyagent/conftest test --policy opa-docker-security.rego Dockerfile'
            }
          )
        }
      }
